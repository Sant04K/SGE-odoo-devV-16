...
class Destino(models.Model):
    ...
    name = fields.Char(string='Ciudad', help="Introducir la ciudad de destino", required=True)
    continente = fields.Char(string='Continente', help="Introducir el continente del destino", required=True)
